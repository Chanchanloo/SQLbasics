...
WHERE x.area >= ALL(SELECT area FROM world y WHERE x.continent = y.continent AND area >0)
...
WHERE x.population >= ALL(SELECT population FROM world y WHERE x.continent = y.continent)  AND population <= 25000000)
